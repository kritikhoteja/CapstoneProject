...
<title>Discipline Head Dashboard</title>
</head>
...
<body>
	...
	<header>
		...
		<h2>Welcome, <%= user %></h2>
		<h2>You log in as a Discipline Head.</h2>
	</header>

	<ul>
		<li class="li_main_menu">
			<a href="allocate_stakeholders.jsp">
			<i class="material-icons main-menu-img" style="font-size:120px;color:#3c1a50">group</i>
			<br>Allocate Stakeholders to Units</a>
		</li>
		<li class="li_main_menu">
			<a href="check_assessments.jsp?role=dh">
			<i class="material-icons main-menu-img" style="font-size:120px;color:#3c1a50">assignment_turned_in</i>
			<br>Approve Revised Assessments</a>
		</li>
	</ul>
